      ...
      <section className="calculatorSection">
        <div className="calculatorGrid">
          <div className="calculatorPanel">
            ...
            <p className="calculatorHint">Версия расчёта: длины профилей включены. Коэффициенты взяты из рабочего расчётного файла и предназначены для предварительной оценки расхода.</p>
          </div>
