...
export const metadata: Metadata = {
  title: "Калькулятор двухконтурного каркаса из строительных лесов | ИДЕЛЕОН",
  description: "Предварительный расчёт двухконтурного пространственного каркаса вокруг здания: стойки, ригели, перемычки, диагонали, опоры и панели.",
    ...
    <main>
      ...
      <section className="pageHero scaffoldHero">
        <Breadcrumbs items={[
          ...
          { label: "Пространственный каркас" },
        ]} />
        <p className="label">Инженерно-коммерческая модель V1</p>
        <h1>Калькулятор двухконтурного пространственного каркаса</h1>
        <p>Предварительно подбирает комплект клиновой или хомутовой системы вокруг прямоугольного здания. Результат предназначен для проверки специалистом и подготовки коммерческого предложения.</p>
      </section>
