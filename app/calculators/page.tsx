...
export const metadata = {
  ...
  description: "Онлайн-калькуляторы Иделеон для расчёта профиля ГКЛ, Грильято, кассетных систем, металлопроката, сэндвич-панелей, стеновых блоков, реечных потолков.",
};
...
const groups = [
  ...
  },
  {
    ...
    description: "Предварительный расчёт стеновых и кровельных сэндвич-панелей, доборных элементов и крепежа.",
  },
  {
    id: "blocks",
    label: "Кладочные материалы",
    title: "Стеновые блоки",
    description: "Расчёт газобетонных и полистиролбетонных блоков, объёма кладки, веса и кладочной смеси.",
  },

{
  id: "rack",
  label: "Линейные потолочные системы",
  title: "Реечные потолки",
  description: "Кубообразные, прямоугольные, итальянские, немецкие, OMEGA, S-, V- и пластинообразные рейки.",
},
] as const;
  ...
  return (
    <main>
      ...
      <section className="pageHero">
        ...
        <p>Выберите направление, получите предварительную комплектацию, скачайте Excel-КП или отправьте расчёт специалисту Иделеон. В каталоге собраны расчёты по ГКЛ, потолкам, металлопрокату, сэндвич-панелям, блокам, реечным потолкам.</p>
      </section>
