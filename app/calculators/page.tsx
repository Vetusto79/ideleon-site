...
export const metadata = {
  ...
  description: "Онлайн-калькуляторы Иделеон для расчёта профиля ГКЛ, потолков Грильято, кассетных систем, чёрного металлопроката, сэндвич-панелей и стеновых блоков.",
};
