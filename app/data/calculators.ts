...
export const calculators: CalculatorConfig[] = [

  {
    ...
    visuals: [
      { title: "Газобетон", description: "Автоклавные ячеистые блоки. Типовой размер в калькуляторе — 625×250 мм.", image: "/images/calculators/blocks/gas-concrete.webp", alt: "Газобетонный стеновой блок", fieldId: "blockMaterial", value: "gas" },
      { title: "Полистиролбетон", description: "Лёгкие блоки с гранулами вспененного полистирола. Типовой размер — 600×300 мм.", image: "/images/calculators/blocks/polystyrene-concrete.webp", alt: "Полистиролбетонный стеновой блок", fieldId: "blockMaterial", value: "polystyrene" },
    ],
    visualGroups: [
      {
        ...
        visuals: [
          { title: "Наружные стены", description: "Внешний контур здания. Стартовая толщина — 300 мм.", image: "/images/calculators/blocks/exterior-walls.webp", alt: "Наружные стены здания", fieldId: "wallType", value: "exterior" },
          { title: "Внутренние несущие", description: "Несущие стены внутри здания. Стартовая толщина — 200 мм.", image: "/images/calculators/blocks/bearing-walls.webp", alt: "Внутренняя несущая стена", fieldId: "wallType", value: "bearing" },
          { title: "Перегородки", description: "Ненесущие разделительные стены. Стартовая толщина — 100 мм.", image: "/images/calculators/blocks/partitions.webp", alt: "Перегородка из строительных блоков", fieldId: "wallType", value: "partition" },
        ],
      },
    ],
    ...
    visualGroups: [
      {
        ...
        visuals: [
          { title: "Здание целиком", description: "Стены, кровля, доборные элементы и крепёж для предварительного бюджета.", image: "/images/calculators/sandwich/building.webp", alt: "Расчёт комплекта сэндвич-панелей на здание", fieldId: "scope", value: "building" },
          { title: "Только стены", description: "Только стеновые панели, проёмы, углы и стартовые элементы.", image: "/images/calculators/sandwich/wall.webp", alt: "Расчёт стеновых сэндвич-панелей", fieldId: "scope", value: "wall" },
          { title: "Только кровля", description: "Кровельные панели, конёк, карниз и фронтонные элементы.", image: "/images/calculators/sandwich/roof.webp", alt: "Расчёт кровельных сэндвич-панелей", fieldId: "scope", value: "roof" },
        ],
      },
      {
        title: "Тип кровли",
        ...
        visuals: [
          { title: "Двускатная кровля", description: "Подходит для складов, ангаров, магазинов и производственных зданий.", image: "/images/calculators/sandwich/gable.webp", alt: "Двускатная кровля из сэндвич-панелей", fieldId: "roofType", value: "gable" },
          { title: "Односкатная кровля", description: "Часто используется для навесов, пристроек и компактных зданий.", image: "/images/calculators/sandwich/single-slope.webp", alt: "Односкатная кровля из сэндвич-панелей", fieldId: "roofType", value: "single" },
        ],
      },
    ],
...

  {
    ...
    visuals: [
      { title: "Арматура", description: "Периодический профиль А500С. Масса по ГОСТ 34028-2016.", image: "/images/calculators/metal/rebar.webp", alt: "Арматура стальная", fieldId: "productType", value: "rebar" },
      { title: "Круг", description: "Круглый стальной пруток произвольного диаметра.", image: "/images/calculators/metal/round.webp", alt: "Круг стальной", fieldId: "productType", value: "round" },
      { title: "Квадрат", description: "Стальной квадрат сплошного сечения.", image: "/images/calculators/metal/square.webp", alt: "Квадрат стальной", fieldId: "productType", value: "square" },
      { title: "Шестигранник", description: "Пруток шестигранного сечения, размер под ключ.", image: "/images/calculators/metal/hexagon.webp", alt: "Шестигранник стальной", fieldId: "productType", value: "hexagon" },
      { title: "Полоса", description: "Плоский стальной прокат по ширине и толщине.", image: "/images/calculators/metal/strip.webp", alt: "Полоса стальная", fieldId: "productType", value: "strip" },
      { title: "Лист", description: "Листовой прокат: масса, площадь и количество листов.", image: "/images/calculators/metal/sheet.webp", alt: "Лист стальной", fieldId: "productType", value: "sheet" },
      { title: "Труба круглая", description: "Наружный диаметр и толщина стенки.", image: "/images/calculators/metal/round-pipe.webp", alt: "Труба стальная круглая", fieldId: "productType", value: "roundPipe" },
      { title: "Труба квадратная", description: "Квадратная профильная труба.", image: "/images/calculators/metal/square-tube.webp", alt: "Труба профильная квадратная", fieldId: "productType", value: "squareTube" },
      { title: "Труба прямоугольная", description: "Прямоугольная профильная труба.", image: "/images/calculators/metal/rect-tube.webp", alt: "Труба профильная прямоугольная", fieldId: "productType", value: "rectTube" },
      { title: "Уголок", description: "Горячекатаный равнополочный уголок по ГОСТ 8509-93.", image: "/images/calculators/metal/angle.webp", alt: "Уголок стальной", fieldId: "productType", value: "angle" },
      { title: "Швеллер", description: "Горячекатаный швеллер серии П по ГОСТ 8240-97.", image: "/images/calculators/metal/channel.webp", alt: "Швеллер стальной", fieldId: "productType", value: "channel" },
      { title: "Двутавр", description: "Горячекатаная двутавровая балка по ГОСТ 8239-89.", image: "/images/calculators/metal/i-beam.webp", alt: "Двутавр стальной", fieldId: "productType", value: "beam" },
    ],
